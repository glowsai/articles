...
### 6.3 Legal Use and BIS Compliance Standards

The User undertakes that when using this service, they must comply with all applicable local and international laws. The following actions that violate the U.S. Bureau of Industry and Security (BIS) and international export control regulations are strictly prohibited:  
- Embargoed and Restricted Countries: This service shall not be used to provide computing power support to entities or individuals in countries subject to international sanctions or embargos (such as Russia, Iran, North Korea, Syria, etc.).
- Military Use Restrictions: It is strictly prohibited to use this service for the development, production, or use of weapons of mass destruction, mass surveillance systems, or any unauthorized military purposes.
- Entity List Compliance: The User guarantees that they are not an object listed on the U.S. BIS "Entity List" or "Denied Persons List," and shall not transfer computing power resources to the aforementioned objects.
- High-Tech Export Control: It is strictly prohibited to use this service for controlled semiconductor design, supercomputer development, or other computing activities that violate the Export Administration Regulations (EAR).
